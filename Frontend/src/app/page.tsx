        ...
        <section className={styles.hero}>
          <div className={styles.heroCopy}>
            ...
            <p className={styles.subtitle}>
              A live quote operations layer where four autonomous agents profile
              risk, predict conversion, evaluate premiums, and route only
              critical cases to human underwriters.
            </p>
